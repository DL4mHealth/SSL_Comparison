...
train_x = np.expand_dims(train_x, axis=1)  # for MAE pstchify
...
val_x = np.expand_dims(val_x, axis=1)  # for MAE pstchify

test_x = test_x[:, :, :n_length]
test_x = zscore_norm(test_x)
test_x = np.expand_dims(test_x, axis=1)  # for MAE pstchify
